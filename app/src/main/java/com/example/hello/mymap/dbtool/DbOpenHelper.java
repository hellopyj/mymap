...
public class DbOpenHelper extends SQLiteOpenHelper {
	...
	private static final String MAPBOX_POINT_TABLE_CREATE = "CREATE TABLE "
			+ MapMarkerDao.TABLE_NAME + " ("
			+ MapMarkerDao.COLUMN_NAME_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ MapMarkerDao.COLUMN_NAME_FROM + " TEXT, "
			+ MapMarkerDao.COLUMN_NAME_GROUP_ID + " TEXT, "
			+ MapMarkerDao.COLUMN_NAME_LATITUDE + " DOUBLE, "
			+ MapMarkerDao.COLUMN_NAME_LONGITUDE + " DOUBLE, "
			+ MapMarkerDao.COLUMN_NAME_TYPE + " INTEGER, "
			+ MapMarkerDao.COLUMN_NAME_ICOTYPE + " INTEGER, "
			+ MapMarkerDao.COLUMN_NAME_CONTENT + " TEXT, "
			+ MapMarkerDao.COLUMN_NAME_TIME + " TEXT);";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//pyj
		db.execSQL(MAPBOX_POINT_TABLE_CREATE);
