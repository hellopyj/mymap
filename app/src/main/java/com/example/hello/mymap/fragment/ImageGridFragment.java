...
import com.example.hello.mymap.activity.RecorderVideoActivity;
import com.example.hello.mymap.domain.VideoEntity;
import com.example.hello.mymap.util.ImageCache;
import com.example.hello.mymap.util.ImageResizer;
import com.example.hello.mymap.util.Utils;
import com.example.hello.mymap.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.addImageCache(getActivity().getFragmentManager(),
				cacheParams);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 100) {
				...
				Toast.makeText(getActivity(), "不能大于100M", Toast.LENGTH_SHORT).show();
				return;
			}
